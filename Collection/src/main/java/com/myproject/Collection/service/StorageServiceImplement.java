...
public class StorageServiceImplement implements StorageService {
    ...
    //MultipartFile is a Spring interface used to handle file uploads
    @Override
    public void store(MultipartFile file) {
        try {
            ...
            //this code check to ensure the file is being stored within the intended directory
            ...
            //reading the contents of the uploaded file and saving it to the designated location
    ...
    //this method will load all file path
    @Override
    public Stream<Path> loadAll() {
        try {
            //the Files.walk return a file path traverse
            // mazdepth means only on this layer of file
            //filter will ignore the rootLocation file path
            //map transform absolute paths to relative paths
